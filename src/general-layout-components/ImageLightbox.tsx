  ...
  render() {
    ...
    return (
      <div
        ...
        <img style={this.props.style} className={this.props.styling + " shadow-xl"} src={this.props.imageSrc} onClick={() => this.setState({ isOpen: true })} />
...
ImageLightbox.defaultProps = { styling: 'object-contain' }