...
- The [intensity](/docs/wiki/actions/led/simple-intensity.md) of the corresponding LED is indicative of the potentiometer value, as its intensity uses the same `val` variable.
